(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_0cc7dadc._.js", {
...
class AuthApi {
    ...
    static async getCurrentUser() {
        return new Promise((resolve)=>{
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$9ae71ce3$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__z__as__onAuthStateChanged$3e$__["onAuthStateChanged"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], async (user)=>{
                unsubscribe();
                if (!user) {
                    resolve(null);
                    return;
...
const AuthProvider = ({ children })=>{
    ...
    const login = async (email, password)=>{
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$AuthApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthApi"].login(email, password);
    ...
    const logout = async ()=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$AuthApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthApi"].signOut();
    };
    const value = {
        currentUser,
        loading,
...
function Navbar() {
    _s();
    const { isAuthenticated, logout, user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
_s(Navbar, "8PmW6rm39Wz4QWdWj17r25QvmT8=", false, function() {
    return [
...
//# sourceMappingURL=src_app_0cc7dadc._.js.map