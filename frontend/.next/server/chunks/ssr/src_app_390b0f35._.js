...
function ProjectList({ title, onEdit, onDelete }) {
    ...
    const loadProjects = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const fetchedProjects = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$ProjectApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ProjectApi"].getUserProjects();
    ...
    const handleDelete = async (id)=>{
        try {
            const success = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$ProjectApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ProjectApi"].deleteProject(id);
            if (success) {
...
function ProtectedRoute({ children }) {
    const { currentUser, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
...
"[project]/src/app/projekty/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ProjektyPage() {
    const { currentUser, loading: authLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])(); // get auth state from context
    const [projects, setProjects] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const loadProjects = async ()=>{
        try {
            const allProjects = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$ProjectApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ProjectApi"].getUserProjects();
    ...
    const handleDeleteProject = async (id)=>{
        if (window.confirm('Are you sure you want to delete this project?')) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$ProjectApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ProjectApi"].deleteProject(id);
                await loadProjects();
            } catch (error) {
...
//# sourceMappingURL=src_app_390b0f35._.js.map